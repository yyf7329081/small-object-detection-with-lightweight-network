...
from model.faster_rcnn.dla_up import dla34up
...
class _fasterRCNN(nn.Module):
    ...
    def __init__(self
        ...
        self.RCNN_base = dla34up(pretrained_base=None, down_ratio=cfg.FEAT_STRIDE)
...
net = load_model(net, "../weights/snetdla_visdrone/dla_34/visdrone/thundernet_epoch_149.pth")
net.eval()
