...
def create_dataset(dataset_txt, image_id, bnd_id):
    ...
    category_map = collections.OrderedDict([('airplane', 1),
                    ('ship', 2),
                    ('storage tank', 3),
                    ('baseball diamond', 4),
                    ('tennis court', 5),
        ...
        for line in f.readlines():
            ...
            with open(txt_path, 'r', encoding='utf-8') as new_f:
                ...
                for index, new_line in enumerate(new_lines):
                    ...
                    assert(category_id>0 and category_id<11),"unknow cate, file:{}, line:{}".format(line,index)
...
trainset_txt = '/home/data/NWPU/trainset.txt'
valset_txt = '/home/data/NWPU/valset.txt'
testset_txt = '/home/data/NWPU/testset.txt'
